#!/usr/bin/env python3
"""
Quick Easyship rate checker
Usage: python check_easyship_rates.py
"""

from dotenv import load_dotenv
load_dotenv()  # Load .env file

from shippo_tool.easyship_client import EasyshipClient
...
def main():
    console.print("[bold cyan]Easyship Rate Check[/bold cyan]")
    ...
    # Display in table
    table = Table(title="Easyship Rates", show_header=True, header_style="bold magenta")
