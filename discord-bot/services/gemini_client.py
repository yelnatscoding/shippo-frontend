...
class GeminiClient:
    ...
    def build_shipping_system_context(self, default_origin: Dict[str, str]) -> str:
        ...
        return (
            ...
            "- Use set_to_address for destination info, set_from_address ONLY when user explicitly provides a DIFFERENT origin\n"
            "- 'from warehouse', 'from default', or 'from office' means use the default origin above — do NOT call set_from_address\n"
