#!/usr/bin/env python3
"""
Quick Shippo rate checker
Usage: python check_shippo_rates.py
"""
...
def main():
    console.print("[bold cyan]Shippo Rate Check[/bold cyan]")
    ...
    # Display in table
    table = Table(title="Shippo Rates", show_header=True, header_style="bold magenta")
