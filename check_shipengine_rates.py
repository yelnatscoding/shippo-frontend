#!/usr/bin/env python3
"""
Quick ShipEngine rate checker
Usage: python check_shipengine_rates.py
"""

from dotenv import load_dotenv
load_dotenv()  # Load .env file

from shippo_tool.shipengine_client import ShipEngineClient
...
def main():
    console.print("[bold cyan]ShipEngine Rate Check[/bold cyan]")
    ...
    # Display in table
    table = Table(title="ShipEngine Rates", show_header=True, header_style="bold magenta")
